...
public class CountryCitySortChangeAdapter extends BaseAdapter {
    ...
    private SignUpOneActivity userDetailFragment;


    public CountryCitySortChangeAdapter(SignUpOneActivity userDetailFragment, List<CountryList> featureList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            layoutInflater = (LayoutInflater) userDetailFragment.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
